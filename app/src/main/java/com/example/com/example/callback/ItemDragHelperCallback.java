...
// 左右为滑动（swipe）。
    ...
    // 要支持长按RecyclerView item进入拖动操作，你必须在isLongPressDragEnabled()方法中返回true，不用调用startDrag。
    // 或者返回false，调用ItemTouchHelper.startDrag(RecyclerView.ViewHolder) 方法来开始一个拖动。
